---
name: provider-tests
description: Use when adding or updating B.O.L.T Riverpod provider tests, notifier tests, or state-management tests in this repository.
---
...
- Do not use `dart test`; B.O.L.T models and provider tests may depend on Flutter types.
